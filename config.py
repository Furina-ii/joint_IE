...
class Config(object):
    def __init__(self, **kwargs):
        ...
        # adding
        self.use_ere_biaffine = kwargs.pop('use_ere_biaffine', True)
        ...
        self.use_high_order_sibling = kwargs.pop('use_high_order_sibling', True)
        self.use_high_order_coparent = kwargs.pop('use_high_order_coparent', True)
        self.use_high_order_ere = kwargs.pop('use_high_order_ere', True)
        self.use_high_order_er = kwargs.pop('use_high_order_er', True)
        self.use_high_order_re_sibling = kwargs.pop('use_high_order_re_sibling', True)
        self.use_high_order_re_coparent = kwargs.pop('use_high_order_re_coparent', True)
        self.use_high_order_re_grandparent = kwargs.pop('use_high_order_re_grandparent', True)
        self.use_high_order_rr_coparent = kwargs.pop('use_high_order_rr_coparent', True)
        self.use_high_order_rr_grandparent = kwargs.pop('use_high_order_rr_grandparent', True)
